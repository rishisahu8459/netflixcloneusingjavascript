    ...
    <header>
        ...
        <div className="header_container">
            <div  className="header_billboard">
             ...
             <img id='img_billboard' src="https://lumiere-a.akamaihd.net/v1/images/avatar_nav_logo_c08aa297.png?region=0,0,500,158" alt="Avatar"></img>
                <div>
                    <h4 className='header_desc' >Jake Sully and Ney'tiri have formed a family and are doing everything to stay together. However, they must leave their home and explore the regions of Pandora. When an ancient threat resurfaces, Jake must fight a difficult war against the humans.</h4>
                </div>
                <p></p>
